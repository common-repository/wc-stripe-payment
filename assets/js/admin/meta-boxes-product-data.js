(function ($) {
    ...
    Product.prototype.init = function () {
        ...
        $('table.wc_gateways .wpp-payment-product-gateway-enabled').on('click', this.enable_gateway.bind(this));
        $('.wpp-payment-save-product-data').on('click', this.save.bind(this));
    ...
    Product.prototype.setting_changed = function () {
        $('#wpp_payment_update_product').val('true');
    }
    ...
    Product.prototype.enable_gateway = function (e) {
        ...
        $.ajax({
            url: wpp_product_params.routes.enable_gateway,
            method: 'POST',
            dataType: 'json',
            data: {
                _wpnonce: wpp_product_params._wpnonce,
    ...
    Product.prototype.save = function (e) {
        ...
        $.ajax({
            url: wpp_product_params.routes.save,
            method: 'POST',
            dataType: 'json',
            data: {
                _wpnonce: wpp_product_params._wpnonce,
                ...
                product_id: $('#post_ID').val(),
                position: $('#wpp_payment_btn_position').val()
            }
        }).done(function (response) {
